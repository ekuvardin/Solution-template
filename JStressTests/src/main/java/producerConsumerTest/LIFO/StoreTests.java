...
public class StoreTests {
    ...
    public static class GetShouldBeUnblocked {
        ...
        volatile IStore<Integer> store = new Store<>(2, Integer.class, new ThreadInterruptedStrategy());
    ...
    public static class GetShouldUnblockPut {
        ...
        protected IStore<Integer> createObject() {
            Store<Integer> object = new Store<>(2, Integer.class, new ThreadInterruptedStrategy());
