package producerConsumerTest.FIRO;
...
public class RandomStartStoreTests {
    ...
    public static class GetShouldBeUnblocked {
        ...
        volatile IStore<Integer> store = new RandomStartStore<>(2, new ThreadInterruptedStrategy());
    ...
    public static class GetShouldUnblockPut {
        ...
        protected IStore<Integer> createObject() {
            RandomStartStore object = new RandomStartStore(2, new ThreadInterruptedStrategy());
