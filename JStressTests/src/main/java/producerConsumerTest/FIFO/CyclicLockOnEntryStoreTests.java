...
public class CyclicLockOnEntryStoreTests {
    ...
    public static class GetShouldBeUnblocked {
        ...
        volatile IStore<Integer> store = new CyclicLockOnEntryStore<>(2, new ThreadInterruptedStrategy());
    ...
    public static class GetShouldUnblockPut {
        ...
        protected IStore<Integer> createObject() {
            CyclicLockOnEntryStore object = new CyclicLockOnEntryStore(2, new ThreadInterruptedStrategy());
